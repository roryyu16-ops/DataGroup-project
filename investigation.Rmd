...
#Table 4 (Agegroup and Diagnosis)
Table_4<- Data %>%
...
ggplot(Table_4, aes(x = Diagnosis, y = mean_cruderate, fill = AgeGroup)) +
...
#Table 5 (Sex and Diagnosis)
Table_5<-Data %>%
  group_by(Sex,Diagnosis) %>%
  summarise(mean_cruderate = mean(CrudeRate , na.rm = TRUE),
            median_cruderate = median(CrudeRate , na.rm = TRUE))
ggplot(Table_5, aes(x = Diagnosis, y = mean_cruderate, fill = Sex)) +
  geom_col(position = position_dodge(width = 0.8)) +
  labs(
...
ggplot(Table_7, aes(x = Year, y = mean_cruderate, fill = Sex)) +
  geom_col(position = position_dodge(width = 0.8)) +
  labs(
...
#Agegroup and year
  ...
  Table_8<-Data %>%
    ...
    summarise(mean_cruderate = mean(CrudeRate , na.rm = TRUE),
              median_cruderate = median(CrudeRate , na.rm = TRUE)) 
  ggplot(Table_8, aes(x = Year, y = mean_cruderate, color =AgeGroup , group = AgeGroup)) +
    geom_line(size = 1) +
    geom_point() +
    labs(
