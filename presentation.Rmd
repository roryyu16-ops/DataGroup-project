...
- train / test data set (randomly 80% / 0.2%)  
...
- Sensitivity = 30 / ( 30 + 32 ) ≈ 0.4839
- Specificity = 534 / ( 534 + 20 ) ≈ 0.9640  
]
.pull-right[
```{r out.width= "75%", fig.align="center", echo = FALSE, message=FALSE}
cutoff_prob <- 0.25
...
- Sensitivity = 24 / ( 24 + 13 ) ≈ 0.6486
- Specificity = 553 / ( 553 + 26 ) ≈ 0.9551  
]
.pull-right[
```{r out.width= "75%", fig.align="center", echo = FALSE, message=FALSE}
cutoff_prob<-0.5
